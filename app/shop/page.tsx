    ...
    <section>
      ...
      <main className="px-6 sm:px-10 md:px-20 lg:px-38 py-10">
        <div>
          ...
          <p className="text-black text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna a</p>
          ...
          <div className="relative bottom-46">
            <div className="flex justify-end mb-4 ">
              <div className="bg-gray-300 px-2 py-1 text-black rounded">Sort by:</div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:ml-60">
              {products.map(p=>(
              <div key={p.id} className="w-72 text-black border-2 border-gray-300 rounded-3xl pb-px mt-8">
                <Image
                  src={p.image}
                  alt={p.name} 
                  width={300} 
                ...
                <div className="p-4 flex-col sm:flex-row sm:justify-between rounded-b-3xl bg-white items-start sm:items-center">
                  ...
                  <button className="mt-3 sm:mt-0 bg-gradient-to-r from-[#62061D] to-[#F89A20] text-white px-21 py-2 rounded-md shadow hover:opacity-90 transition"> Add to cart </button>
                </div>
              </div>
              ))}
            </div>
